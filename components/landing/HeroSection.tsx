    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* YouTube Video Thumbnail - Opens in new tab */}
          <motion.div
          ...
          >
            <a
              href="https://youtu.be/khLQv7BnvmY"
              target="_blank"
              rel="noopener noreferrer"
              className="block relative rounded-2xl overflow-hidden border-2 border-gold/30 shadow-2xl shadow-gold/10 group cursor-pointer"
            >
              {/* YouTube Thumbnail */}
              <img
                src="https://img.youtube.com/vi/khLQv7BnvmY/maxresdefault.jpg"
                alt="Watch the BG Wealth Sharing introduction video"
              ...
              <div className="absolute inset-0 flex items-center justify-center bg-black/30 group-hover:bg-black/40 transition-colors">
                <div className="w-20 h-20 rounded-full bg-gold flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                  <Play className="w-10 h-10 text-navy-dark fill-navy-dark ml-1" />
                </div>
              </div>

              {/* "Watch on YouTube" label */}
              <div className="absolute bottom-4 right-4 px-3 py-1.5 bg-black/70 rounded-lg flex items-center gap-2">
